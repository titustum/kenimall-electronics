<x-layouts.app> {{-- Assuming your admin layout component is x-layouts.app --}}
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-4">
        ...
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Products Management</h2>

        <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">All Products</h3>
            ...
            @if($products->isEmpty())
            <p class="text-gray-600 dark:text-gray-400">No products found. Start by adding one!</p>
            @else
