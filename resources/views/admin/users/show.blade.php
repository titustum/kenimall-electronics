    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-4">
        ...
        <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 border-t border-gray-200 dark:border-neutral-700 pt-6 mt-6">
                    ...
                    <form action="{{ route('admin.orders.update', $order) }}" method="POST" class="space-y-4">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="update_field" value="shipping_tracking"> {{-- Hidden field to
                        indicate shipping tracking update --}}

                        <div>
                            <label for="tracking_number"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tracking
                                Number</label>
                            <input type="text" name="tracking_number" id="tracking_number"
                                value="{{ old('tracking_number', $order->tracking_number) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:border-orange-500 focus:ring-orange-500 dark:bg-neutral-700 dark:border-neutral-600 dark:text-white @error('tracking_number') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="carrier" id="carrier" value="{{ old('carrier', $order->carrier) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:border-orange-500 focus:ring-orange-500 dark:bg-neutral-700 dark:border-neutral-600 dark:text-white @error('carrier') border-red-500 @enderror">
                            @error('carrier')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="flex items-center justify-end mt-6 pt-6 border-t border-gray-200 dark:border-neutral-700 gap-4">
                ...
                {{-- Edit Order Button (if you implement an edit form for orders) --}}
