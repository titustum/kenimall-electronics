...
<head>
    ...
    <!-- Title -->
    <title>Home | Kamarona - #1 Electronics shopping mall in Australia</title>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="https://transvelo.github.io/electro-html/2.0/favicon.png">
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/hs.megamenu.css') }}">
                        ...
                        <div class="col-auto">
                            ...
                            <nav
                                ...
                                <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center"
                                    href="../home/index.html" aria-label="kamarona">
                                    <div
                                        style="font-size: 2.2rem; color: black; opacity: 0.8; font-weight: 800; display: flex; align-items: center">
                                        <span>kamarona</span>
                                        <span style="color: green; font-size: 3rem; padding-bottom: -3px">.</span>
                                    </div>
                                </a>
                                <!-- End Logo -->
                        ...
                        <div class="d-none d-xl-block col-md-auto">
                            <div class="d-flex">
                                ...
                                <div class="ml-2">
                                    ...
                                    <div class="email">
                                        E-mail: <a href="mailto:info@kamarona.com?subject=Help Need"
                                            class="text-gray-90">info@kamarona.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <ul
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                    ...
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid"
                                                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/500X400/img1.png"
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                    ...
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid"
                                                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/500X400/img4.png"
                                                                            alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu vmm-bg-extended"
                                                                    ...
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid"
                                                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/500X400/img3.png"
                                                                            alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                    ...
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid"
                                                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/500X400/img2.png"
                                                                            alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                    ...
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid"
                                                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/500X400/img5.png"
                                                                            alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                    ...
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid"
                                                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/500X400/img6.png"
                                                                            alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                    ...
                                                                    <div class="vmm-bg">
                                                                        <img class="img-fluid"
                                                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/500X400/img7.png"
                                                                            alt="Image Description">
                                                                    </div>
                                                                    <div class="row u-header__mega-menu-wrapper">
                                                                        <div class="col mb-3 mb-sm-0">
                            ...
                            <div class="row min-height-438 pt-7 py-md-0">
                                ...
                                <div class="col-xl-5 col-6 d-flex align-items-end ml-auto ml-md-0"
                                    ...
                                    <img class="img-fluid ml-auto mr-5"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/374X386/img1.png"
                                        alt="Image Description">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="max-width-270 min-width-270 pt-xl-13 mt-xl-13">
                        ...
                        <aside class="mb-8">
                            <a href="../shop/shop.html" class="d-block">
                                <img class="img-fluid"
                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/270X428/img1.jpg"
                                    alt="Image Description">
                            </a>
                        </aside>
                        <!-- End Image Banner -->
                                                        ...
                                                        <div class="col-auto product-media-left">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="max-width-70 d-block"><img class="img-fluid"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/150X140/img1.jpg"
                                                ...
                                                <div class="product-item__outer h-100">
                                                    <div
                                                        ...
                                                        <div class="col-auto product-media-left">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="max-width-70 d-block"><img class="img-fluid"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/150X140/img2.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                                                        <div class="col product-item__body pl-2 pl-lg-3">
                                                            <div class="mb-4">
                                                ...
                                                <div class="product-item__outer h-100">
                                                    <div
                                                        ...
                                                        <div class="col-auto product-media-left">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="max-width-70 d-block"><img class="img-fluid"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/150X140/img3.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                                                        <div class="col product-item__body pl-2 pl-lg-3">
                                                            <div class="mb-4">
                                                ...
                                                <div class="product-item__outer h-100">
                                                    <div
                                                        ...
                                                        <div class="col-auto product-media-left">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="max-width-70 d-block"><img class="img-fluid"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/150X140/img7.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                                                        <div class="col product-item__body pl-2 pl-lg-3">
                                                            <div class="mb-4">
                                                ...
                                                <div class="product-item__outer h-100">
                                                    <div
                                                        ...
                                                        <div class="col-auto product-media-left">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="max-width-70 d-block"><img class="img-fluid"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/150X140/img4.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                                                        <div class="col product-item__body pl-2 pl-lg-3">
                                                            <div class="mb-4">
                                                ...
                                                <div class="product-item__outer h-100">
                                                    <div
                                                        ...
                                                        <div class="col-auto product-media-left">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="max-width-70 d-block"><img class="img-fluid"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/150X140/img5.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                                                        <div class="col product-item__body pl-2 pl-lg-3">
                                                            <div class="mb-4">
                                                ...
                                                <div class="product-item__outer h-100">
                                                    <div
                                                        ...
                                                        <div class="col-auto product-media-left">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="max-width-70 d-block"><img class="img-fluid"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/150X140/img6.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                                                        <div class="col product-item__body pl-2 pl-lg-3">
                                                            <div class="mb-4">
                                                ...
                                                <div class="product-item__outer h-100">
                                                    <div class="product-item__inner py-md-3 mx-3 row no-gutters">
                                                        <div class="col-auto product-media-left">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="max-width-70 d-block"><img class="img-fluid"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/150X140/img8.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                                                        <div class="col product-item__body pl-2 pl-lg-3">
                                                            <div class="mb-4">
                                            ...
                                            <div class="product-item__body pb-xl-2">
                                                <div class="mb-3">
                                                    <a href="../blog/single-blog-post.html"
                                                        class="d-block text-center"><img class="img-fluid"
                                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/270X180/img1.jpg"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="mb-1"><a
                                                        href="../shop/product-categories-7-column-full-width.html"
                                                        ...
                                                        <div class="col">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="d-block text-center"><img
                                                                    ...
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/380X350/img1.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                                                            ...
                                                            <ul class="list-group rounded-0">
                                                                <li class="list-group-item my-1 p-0 border-0">
                                                                    ...
                                                                    <a class="js-fancybox max-width-70 u-media-viewer"
                                                                        ...
                                                                        data-caption="Kamarona in frames - image #01"
                                                                ...
                                                                <li class="list-group-item my-1 p-0 border-0">
                                                                    ...
                                                                    <a class="js-fancybox max-width-70 u-media-viewer"
                                                                        ...
                                                                        data-fancybox="fancyboxGallery6"
                                                                        data-caption="Kamarona in frames - image #02"
                                                                        data-speed="700" data-is-infinite="true">
                                                                        <img class="img-fluid border"
                                                                ...
                                                                <li class="list-group-item my-1 p-0 border-0">
                                                                    ...
                                                                    <a class="js-fancybox max-width-70 u-media-viewer"
                                                                        ...
                                                                        data-fancybox="fancyboxGallery6"
                                                                        data-caption="Kamarona in frames - image #03"
                                                                        data-speed="700" data-is-infinite="true">
                                                                        <img class="img-fluid border"
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <a href="../shop/single-product-fullwidth.html"
                                                                class="d-block text-center"><img
                                                                    class="img-fluid mx-auto"
                                                                    src="https://transvelo.github.io/electro-html/2.0/assets/img/380X350/img2.jpg"
                                                                    alt="Image Description"></a>
                                                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="row">
                            <div class="col-auto">
                                <a href="../shop/shop.html" class="d-block">
                                    <img class="img-fluid"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/212X305/img1.jpg"
                                        alt="Image Description">
                                </a>
                            </div>
                            <div class="col">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="row">
                            <div class="col-auto">
                                <a href="../shop/shop.html" class="d-block">
                                    <img class="img-fluid"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/212X305/img2.jpg"
                                        alt="Image Description">
                                </a>
                            </div>
                            <div class="col">
            ...
            <div class="py-2 border-top border-bottom">
                <div class="js-slick-carousel u-slick my-1" data-slides-show="5" data-slides-scroll="1"
                    ...
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/200X60/img1.png"
                                alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/200X60/img2.png"
                                alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                    ...
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/200X60/img4.png"
                                alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/200X60/img5.png"
                                alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/200X60/img6.png"
                                alt="Image Description">
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                        ...
                        <ul class="list-unstyled products-group">
                                ...
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html"
                                        class="d-block width-75 text-center"><img class="img-fluid"
                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img1.jpg"
                                            alt="Image Description"></a>
                                </div>
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html"
                                        class="d-block width-75 text-center"><img class="img-fluid"
                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img2.jpg"
                                            alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="../shop/single-product-fullwidth.html"
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html"
                                        class="d-block width-75 text-center"><img class="img-fluid"
                                            src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img3.jpg"
                                            alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="../shop/single-product-fullwidth.html"
                    ...
                    <ul class="list-unstyled products-group">
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html"
                                    class="d-block width-75 text-center"><img class="img-fluid"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img4.jpg"
                                        alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0"><a href="../shop/single-product-fullwidth.html"
                        ...
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html"
                                    class="d-block width-75 text-center"><img class="img-fluid"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img5.jpg"
                                        alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0"><a href="../shop/single-product-fullwidth.html"
                        ...
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html"
                                    class="d-block width-75 text-center"><img class="img-fluid"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img6.jpg"
                                        alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0"><a href="../shop/single-product-fullwidth.html"
                    ...
                    <ul class="list-unstyled products-group">
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html"
                                    class="d-block width-75 text-center"><img class="img-fluid"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img7.jpg"
                                        alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0"><a href="../shop/single-product-fullwidth.html"
                        ...
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html"
                                    class="d-block width-75 text-center"><img class="img-fluid"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img8.jpg"
                                        alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0"><a href="../shop/single-product-fullwidth.html"
                        ...
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html"
                                    class="d-block width-75 text-center"><img class="img-fluid"
                                        src="https://transvelo.github.io/electro-html/2.0/assets/img/75X75/img9.jpg"
                                        alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0"><a href="../shop/single-product-fullwidth.html"
                ...
                <div class="col-wd-3 d-none d-wd-block">
                    <a href="../shop/shop.html" class="d-block"><img class="img-fluid"
                            src="https://transvelo.github.io/electro-html/2.0/assets/img/330X360/img1.jpg"
                            alt="Image Description"></a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-14 py-2">
            <div class="container">
                <div class="flex-center-between d-block d-md-flex">
                    <div class="mb-3 mb-md-0">© <a href="#" class="font-weight-bold text-gray-90">Kamarona</a> - All
                        rights Reserved</div>
                    <div class="text-md-right">
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/100X60/img1.jpg"
                                alt="Image Description">
                        </span>
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/100X60/img2.jpg"
                                alt="Image Description">
                        </span>
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/100X60/img3.jpg"
                                alt="Image Description">
                        </span>
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/100X60/img4.jpg"
                                alt="Image Description">
                        </span>
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5"
                                src="https://transvelo.github.io/electro-html/2.0/assets/img/100X60/img5.jpg"
                                alt="Image Description">
                        </span>
                    </div>
                </div>
                        ...
                        <div class="u-sidebar__content u-header-sidebar__content">
                            <form class="js-validate">
                                ...
                                <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                    <!-- Title -->
                                    <header class="text-center mb-7">
                                        <h2 class="h4 mb-0">Welcome to Kamarona.</h2>
